...
def load_sample_data():
    ...
    data = TimingData()
    sample_file = os.path.join(os.path.dirname(__file__), 'data', 'sample_timing_data.csv')
    ...
    # If failed to load sample data, generate it
...
# Load sample data 
timing_data = load_sample_data()

# Import visualization libraries only when needed to avoid dependencies
try:
    import plotly.express as px
    import plotly.graph_objects as go
except ImportError:
    # Define fallback visualizations with simple HTML if plotly is not available
    px = None
    go = None
...
# Define chart callbacks with error handling
@app.callback(
...
if __name__ == '__main__':
    print("🚀 Starting Hardware Timing Dashboard...")
